"""
Demo end-to-end (ME) — Login ➜ Checkout (plan_type + variant) ➜ Webhook (log) ➜ Portal ➜ Risorse (get/consume/set)
...
def main():
    ...
    if MAKE_CHECKOUT:
        try:
            ...
            # Esempi variant: "free-monthly", "base-monthly", "pro-annual", ecc.
            plan_type = "AI Standard"         # famiglia di prodotto lato server
            variant   = "base_monthly"  # cambia qui per testare upgrade/downgrade
